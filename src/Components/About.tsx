        ...
        <section id="about" className='about'>
            ...
            {type === 'english' && <article className="about__info">
                ...
                <div className='about__info__bio'>
                    <p>I am a musician and producer from ICESI University of Cali, Colombia.
                        I have more than 11 years of experience as a solo singer and as member of choral ensembles. I have also worked as an assistant in studio recordings, and I am currently projecting my career as a composer in the world of audio for audiovisual and interactive media.
                    </p>
                </div>
